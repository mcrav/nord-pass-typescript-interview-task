...
- Tab added showing passwords older than 30 days
- Username and password validation added to login page
- Loader added to login page
- Bug in password update functionality fixed in server
- Stopped page reload after updating password
- Added tests
- Added documentation and tidied up code
- Fixed bug in `itemHasWeakPassword` function causing test to fail
- Fixed console warnings

All branches from above changes have been kept in case you want to look at certain diffs individually.
